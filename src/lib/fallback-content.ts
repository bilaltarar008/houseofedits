...
export const fallbackSiteSettings: SiteSettings = {
  ...
  framesVideo: {
    ...
    poster: { url: "/images/front-page-video-poster1.png", alt: "House of Edits frames reel poster" },
  },
  gallery: [
...
export const fallbackServices: ServicePackage[] = [
  {
    _id: "s-1",
    title: "Full-Length Wedding Video",
    slug: "full-length-wedding-video",
    summary:
      "Relive every moment of your wedding day through a beautifully edited full-length film. We carefully organize and edit your footage to preserve the complete story, from the smallest details to the most memorable moments.",
    perfectFor: "Mehndi, Barat, Walima, Nikkah, and complete wedding coverage.",
    turnaround: "3–4 weeks first cut",
    deliverables: [
      "Complete ceremony & event coverage",
      "Multicam sync & edit",
      "Full color grade",
      "Licensed music + speeches mix",
      "4K delivery",
    ],
    icon: "film",
    featured: true,
  ...
  },
  {
    ...
    summary:
      "A cinematic highlight that captures the energy, emotions, and most memorable moments of your event. Edited to music with carefully selected shots, smooth pacing, and a visually engaging storytelling style.",
    perfectFor: "Weddings, receptions, corporate events, and special occasions.",
    turnaround: "10–14 days first cut",
    deliverables: [
      "3–6 minute highlight edit",
      "Music-driven pacing & sound design",
      "Full color grade",
  ...
  },
  {
    ...
    slug: "couple-shoot",
    summary:
      "A romantic, cinematic edit that brings your couple shoot to life. We focus on natural chemistry, beautiful details, and music-driven storytelling to create a film that feels personal and timeless.",
    perfectFor: "Pre-wedding shoots, engagement sessions, and couple portraits.",
    turnaround: "7–10 days first cut",
    deliverables: [
      "2–4 minute cinematic edit",
      "Music-driven storytelling",
      "Color grade & tone matching",
  ...
  },
  {
    ...
    slug: "wedding-teaser",
    summary:
      "A short, captivating preview designed to build anticipation for your wedding film. With striking visuals, emotional moments, and impactful music, the teaser gives your audience a glimpse of the story to come.",
    perfectFor: "Wedding announcements, social media, and pre-release promotions.",
    turnaround: "48 hours",
    deliverables: [
  ...
  },
  {
    ...
    slug: "wedding-film",
    summary:
      "A complete cinematic storytelling experience that goes beyond a traditional wedding video. We combine carefully selected moments, emotional pacing, music, and creative editing to tell your wedding story in a way that feels authentic and unforgettable.",
    perfectFor:
      "Couples looking for a premium, story-driven wedding film that captures the essence of their celebration.",
    turnaround: "2–3 weeks first cut",
    deliverables: [
      "6–12 minute cinematic film",
